...
def do_event(event, data={}, session_id=None, printer_id=None, control=False):
    ...
    for qid in qids:
        ...
        if not w:
            raise UserError(_('Error!'), _('Timeout happen!!'))
...
class FiscalPrinterController(http.Controller):
    ...
    @http.route('/login', auth="public", type="json", method=['POST'], csrf=False)
    ...
    @http.route('/push', auth="public", type="json", method=['POST'], csrf=False)
    ...
    @http.route('/spool', auth="public", type="json", method=['POST'], csrf=False)
    ...
    @http.route('/fp_info', auth="public", type="json", method=['POST'], csrf=False)
